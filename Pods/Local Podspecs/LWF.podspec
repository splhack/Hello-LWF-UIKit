Pod::Spec.new do |s|
  s.name         = 'LWF'
  s.version      = '20131209'
  s.summary      = 'Lightweight SWF'
  s.description  = <<-DESC
                   LWF is an animation engine which can play animation data converted from FLASH contents in HTML5 and Unity. LWF is designed to make game development easy and fun.
                   DESC
